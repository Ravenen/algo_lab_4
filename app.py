...
def generate_one_letter_differ_regex(string: str) -> List[Pattern]:
    result_regex_list = []
...
def is_one_letter_differ(full_string: str, substring: str) -> bool:
...
def fill_in_graph_with_words(input_graph: Graph, input_words_list: List[str]) -> Graph:
